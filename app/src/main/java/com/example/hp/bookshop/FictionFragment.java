...
public class FictionFragment extends Fragment {
    ...
    public String url = "https://www.googleapis.com/books/v1/volumes?q=fiction";
    ProgressDialog progressDialog;
    ListView listView;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        View rootView = inflater.inflate(R.layout.fragment_fiction,container,false);
        listView = (ListView)rootView.findViewById(R.id.list_view_fiction);
        populate();
        return rootView;
    }
